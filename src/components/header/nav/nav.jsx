...
function Nav() {
    return(
        ...
        <nav className='bg-white  flex flex-col md:flex-row md:bg-white border md:border-0  gap-4'>
            ...
            <NavLink  to='/home' className={(navData) => navData.isActive ? 'm-2 mb-0 p-2 text-primary md:border-b-2 dark:text-primary md:border-primary ' : 'm-2 p-2 mb-0' }> Home</NavLink>
