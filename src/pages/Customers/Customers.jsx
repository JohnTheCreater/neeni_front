...
export default function Customers() {
  ...
  const handleCustomerClick = async(user,index)=>{
  ...
  <button onClick={()=>setIsBillListOpen(false)}  className="bg-red-500 p-2 text-white rounded-lg ">close</button>
    ...
    <BillList user={selectedUser} userList={list} /> 
    </div>
    </div>}
        ...
        <div className="h-full w-full items-center  p-2">
          ...
          <div className=" m-10 border bg-white  rounded-[1rem] overflow-auto min-h-[60vh] max-h-[60vh]">
            ...
            <React.Fragment key={user.id}>
              <tr className="border border-2 border-gray-100" onClick={() => handleCustomerClick(user, index)}>
                ...
                <td className="text-center p-2">{user.mobileno}</td>
                <td className="text-center p-2">{user.email}</td>
                <td className="text-center p-2">{user.pincode}</td>
                <td className="text-center p-2">{user.bill_amount}</td>
                <td className="text-center p-2">{user.unpaid}</td>
              </tr>
